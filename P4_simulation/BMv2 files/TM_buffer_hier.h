...
#include </home/vagrant/dr_pifo_simulation/utils/user_externs_hier/hier.h>
...
//std::vector<unsigned int> bm::hier_scheduler::number_of_pkts_per_queue_each_level = {80}; // one level
...
std::vector<unsigned int> bm::hier_scheduler::quota_each_queue = {3000,3000,3000,3000,3000,3000,3000,3000};
